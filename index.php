...
$bowner = "<a href='t.me/menhxa'>MENHERA</a>";
//$header = "MENHERA";
...
//========[OWNER DATA]===//
  ...
  if (($userId == "5415500329") || ($userId == "5415500329"))
  {
    $role = "OWNER";
  }
if ($chatId != $userId)
...
{
  sendMessage($chatId,"➪ 𝗖𝗛𝗔𝗧 𝗡𝗢𝗧 𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘𝗗 ⚠️ 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗢𝗪𝗡𝗘𝗥,$messageId);
 exit();
}
}
